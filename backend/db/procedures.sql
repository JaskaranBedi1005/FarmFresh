...
-- ============================================================
-- FARMFRESH - PL/SQL Stored Procedures, Functions & Triggers
-- ============================================================

-- ─── PACKAGE SPECIFICATION ────────────────────────────────────────
CREATE OR REPLACE PACKAGE farmfresh_pkg AS
  ...
  PROCEDURE clear_cart(p_user_id IN NUMBER);

  FUNCTION  get_cart(p_user_id IN NUMBER) RETURN SYS_REFCURSOR;
  ...
  -- Farmer stats
  FUNCTION  get_farmer_stats(p_farmer_id IN NUMBER) RETURN SYS_REFCURSOR;
  ...
  BEGIN
    OPEN v_cursor FOR
      SELECT ci.cart_item_id, ci.product_id, ci.quantity, ci.added_at,
             ...
             p.farmer_id, u.name AS farmer_name,
...
-- ─── VIEW: Product listing with farmer info ───────────────────────
